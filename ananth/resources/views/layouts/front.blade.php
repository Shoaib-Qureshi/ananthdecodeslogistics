...
<head>
    ...
    <style>
        ...
        .adl-page-banner h1{color:#fff;font-family:"Playfair Display",Georgia,serif;font-size:clamp(2.15rem,4vw,4rem);line-height:1.14;font-weight:500;margin:0 0 1rem}
        ...
        .adl-resource-card h3{color:#0f172a;font-family:"Playfair Display",Georgia,serif;font-size:clamp(1.18rem,1.7vw,1.45rem);line-height:1.22;margin:0 0 .75rem}
