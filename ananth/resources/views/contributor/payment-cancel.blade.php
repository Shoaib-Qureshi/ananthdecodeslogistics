...
@section('title', 'Expert Desk Payment Cancelled - Ananth Decodes Logistics')
@section('description', 'Your Expert Desk checkout was cancelled before payment completed.')
...
<style>
    ...
    .paymentStatusPanel li + li { margin-top: 0.55rem; }
    ...
    @media (max-width: 575px) {
        ...
        .paymentStatusLead { font-size: 1rem; }
        .paymentStatusBtn {
            width: 100%;
            min-width: 0;
        }
            ...
            <div class="paymentStatusCard text-center">
                <div class="paymentStatusInner">
                    ...
                    <div class="paymentStatusHero">
                        <h1>Your Expert Desk payment was not completed</h1>
                        <p class="paymentStatusLead">
                            No Expert Desk access was activated. You can return to The Expert Desk plans page and restart checkout whenever you are ready.
                        </p>
                    </div>
                    ...
                    <div class="paymentStatusPanel">
                        ...
                        <ul>
                            <li>Choose the plan that fits your desired publishing window and article volume.</li>
                            <li>Use the same email address if you want your payment and contributor setup to stay connected.</li>
                            <li>Once payment succeeds, we will send your password setup link right away.</li>
                        </ul>
                    </div>

                    <div class="paymentStatusActions">
                        <a href="{{ route('contributor.register') }}" class="paymentStatusBtn paymentStatusBtnPrimary">Back to The Expert Desk Plans</a>
