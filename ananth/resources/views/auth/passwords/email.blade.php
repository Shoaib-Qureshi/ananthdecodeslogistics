...
<head>
    ...
    <title>Reset Password — Ananth Decodes Logistics</title>
    ...
    <style>
        ...
        .card { border-radius:18px;padding:2.5rem;width:100%;max-width:420px;box-shadow:0 20px 60px rgba(0,0,0,.25);border:none; }
...
<body>
    <div class="card">
        <div class="text-center mb-4">
            ...
            <p class="text-muted mt-1 mb-0" style="font-size:.875rem;">Contributor Portal</p>
        </div>

        <h5 class="fw-bold mb-3" style="color:#1a3c5e;">Reset your password</h5>

        @if(session('status'))
            <div class="alert alert-success py-2 px-3 rounded-3 mb-3" style="font-size:.875rem;">
                {{ session('status') }}
            </div>
        @endif
        ...
        <div class="text-center mt-3">
            <a href="{{ route('contributor.login') }}" style="font-size:.82rem;color:#64748b;">← Back to login</a>
        </div>
    </div>
</body>
</html>
