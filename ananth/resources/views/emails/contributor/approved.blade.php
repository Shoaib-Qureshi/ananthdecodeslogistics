...
<p>Welcome to the Ananth Decodes Logistics contributor community.</p>
</div>
<div class="body">
<p>Hi <strong>{{ $user->name }}</strong>,</p>
<p>Congratulations! Your application to become a contributor on <strong>Ananth Decodes Logistics</strong> has been approved.</p>
<div class="highlight">
<strong>Next step:</strong> Click the link in the password setup email sent separately to <strong>{{ $user->email }}</strong> to set your password and access your contributor dashboard.
</div>
<p>Once your password is set, you can log in at:</p>
<a href="{{ url('contributor-login') }}" class="btn">Access Contributor Dashboard →</a>
<p style="margin-top:20px;">We look forward to reading your insights on global logistics!</p>
</div>
