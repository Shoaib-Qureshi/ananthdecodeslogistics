    ...
    public function down()
    {
        if (Schema::hasTable('users')) {
            Schema::table('users', function (Blueprint $table) {
                ...
                foreach (['contributor_plan', 'payment_status', 'stripe_customer_id', 'activated_at'] as $column) {
        ...
        if (Schema::hasTable('contributor_posts')) {
            Schema::table('contributor_posts', function (Blueprint $table) {
                ...
                foreach (['is_featured', 'feature_source_plan', 'meta_title', 'meta_description', 'meta_keywords', 'canonical_url', 'og_image', 'robots_index', 'robots_follow', 'schema_json_ld'] as $column) {
                    if (Schema::hasColumn('contributor_posts', $column)) {
                        $columns[] = $column;
                    }
                }
        ...
        if (Schema::hasTable('blogs')) {
            Schema::table('blogs', function (Blueprint $table) {
                ...
                foreach (['meta_title', 'meta_description', 'meta_keywords', 'canonical_url', 'og_image', 'robots_index', 'robots_follow', 'schema_json_ld'] as $column) {
        ...
        if (Schema::hasTable('home_pages')) {
            Schema::table('home_pages', function (Blueprint $table) {
                ...
                foreach (['meta_title', 'meta_description', 'meta_keywords', 'canonical_url', 'og_image', 'robots_index', 'robots_follow', 'schema_json_ld'] as $column) {
                    if (Schema::hasColumn('home_pages', $column)) {
                        $columns[] = $column;
                    }
                }
